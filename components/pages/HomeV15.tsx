...
/**
 * HomeV15: Phone in statement section (replaces body text, plays video)
 *           Calculator early, between statement and service panels
 *
 * Flow: Hero → Phone+Statement → Calculator → Services → Stats → CTA
 * Front-loads both the visual hook and the ROI case before services are shown.
 */
    ...
    <div className="min-h-screen bg-charcoal">
      ...
      <section ref={statementRef} className="relative overflow-hidden">
        ...
        <div className="relative z-10 h-full max-w-[1400px] mx-auto px-8 lg:px-20 flex items-center" style={{ minHeight: '820px' }}>
          <div className="w-full grid grid-cols-1 lg:grid-cols-[1fr_460px] gap-16 lg:gap-24 items-center py-24 lg:py-0">
            <Reveal>
            ...
            <div ref={phoneRef} className="flex justify-center" style={{ opacity: phoneInView ? 1 : 0, transform: phoneInView ? 'translateY(0)' : 'translateY(48px)', transition: 'opacity 1.1s ease-out 0.15s, transform 1.1s cubic-bezier(0.23,1,0.32,1) 0.15s' }}>
              <PhoneMockup width={440} videoSrc="/videos/property-tour.mp4" />
            </div>
          </div>
        </div>
      </section>
