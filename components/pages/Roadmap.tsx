...
const RoadmapContent = () => {
  ...
  return (
    <div className="min-h-screen bg-charcoal">
      <SceneSection backgroundImage="/images/roadmap-vision.jpg" parallax overlay="heavy">
      ...
      <SceneSection backgroundImage="/images/roadmap-present.jpg" parallax overlay="medium">
        <div className="container mx-auto px-6 py-32">
          <div className="max-w-5xl mx-auto">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-4 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
                {[
                  copy.roadmap.scene2.features.quality,
                  copy.roadmap.scene2.features.speed,
                  copy.roadmap.scene2.features.scale,
                ].map((feature, i) => (
                  <div key={i} className="p-6 bg-card/80 backdrop-blur-sm border border-gold/20 rounded-xl hover:border-gold/40 transition-smooth">
      ...
      <SceneSection backgroundImage="/images/roadmap-future.jpg" parallax overlay="medium" id="expanding-horizons">
        <div className="container mx-auto px-6 py-32">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <div className="grid md:grid-cols-3 gap-6 pt-8">
              {[
                { icon: Lightbulb, feature: copy.roadmap.scene3.features.insights, delay: '0.2s' },
                { icon: Rocket, feature: copy.roadmap.scene3.features.automation, delay: '0.3s' },
                { icon: Zap, feature: copy.roadmap.scene3.features.lightningFast, delay: '0.4s' },
              ].map(({ icon: Icon, feature, delay }, i) => (
                <div key={i} className="p-6 bg-charcoal/60 backdrop-blur-sm border border-gold/20 rounded-xl animate-fade-in-up" style={{ animationDelay: delay }}>
      ...
      <SceneSection backgroundImage="/images/roadmap-horizon.jpg" parallax overlay="heavy">
        <div className="container mx-auto px-6 py-32">
        ...
        <div className="container mx-auto px-6 py-32">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center pt-8 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
              <Button size="lg" className="text-lg px-10 py-7 bg-gold hover:bg-gold/90 text-charcoal font-bold shadow-gold animate-glow transition-smooth">
...
const Roadmap = () => {
  ...
  return (
    <div className="min-h-screen bg-charcoal">
      ...
      >
        <img src="/images/estatevision-logo.png" alt="EstateVisio" className="h-10 w-auto" />
      </Link>
      <Navigation />
      <div
        className={cn(
