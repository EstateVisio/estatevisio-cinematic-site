...
export const copy = {
  ...
  navigation: {
    ...
    services: { en: 'How it Works', bg: 'Как работи' },
  ...
  visionPage: {
    ...
    intro: {
      paragraph1: {
        en: 'Every listing is competing for the same attention. Static photos no longer stop anyone. The properties that sell faster are the ones that make buyers feel something before they walk through the door.',
    ...
    cta: {
      ...
      description: {
        ...
        bg: 'Вижте как EstateVisio превръща вашите обяви във филмови изживявания.',
      },
  ...
  // CTA Section
  cta: {
    overline: { en: 'Begin today', bg: 'Започнете днес' },
  ...
  contact: {
    ...
    form: {
      ...
      headline: { en: 'Send us a message', bg: 'Изпратете ни съобщение' },
    },
    booking: {
      title: { en: 'Book a call', bg: 'Запазете разговор' },
      description: { en: 'Prefer to talk? Schedule a free 20-minute call and we will walk you through everything.', bg: 'Предпочитате разговор? Запазете безплатен 20-минутен разговор и ще ви преведем през всичко.' },
      cta: { en: 'Schedule a Call', bg: 'Запазете разговор' },
    },
    info: {
      email: { en: 'Email', bg: 'Имейл' },
  ...
  servicesPage: {
    ...
    included: {
      title: { en: "What's included", bg: 'Какво включва услугата' },
      items: {
        en: [
          'Cinematic property video with professional AI motion & lighting',
          'Background music & sound design',
          'HD export ready for web & social',
          'Revision rounds included',
          '24–48 hour delivery',
        ],
        bg: [
          'Кинематографично видео на имота с професионално AI движение и осветление',
          'Фонова музика и звуков дизайн',
          'HD експорт за уеб и социални мрежи',
          'Включени кръгове корекции',
          'Доставка в рамките на 24–48 часа',
        ],
      },
    },
    closing: {
